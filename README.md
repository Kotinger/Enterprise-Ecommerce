...
RFM (`segment`, `R`) дописывается из `report.py` в `people.parquet` и уходит в MySQL.
...
**Продажи**
- GMV **57 499 390**, заказов **150 000**, AOV **383.33**
- Страны почти ровные: топ Brazil / France / USA (7.42M / 7.42M / 7.25M) - сильной концентрации нет
- Пик месяца: **2022-05**. Хвост **2024-06** ниже полного месяца - не сравнивать с полными

**Клиенты**
- **24 938** клиентов с покупками; заказов на человека min / median / max = **1 / 6 / 18**
- Repeat **98.5%**
- LTV median **2 206.22**
- RFM: чемпионы **333** - 2 904 клиента (12% людей, 19% GMV); остывшие **R=1** - 33.3% клиентов (27.5% GMV)
- Отток `churn_label=1`: **21.6%** клиентов; LTV median почти как у активных - отток не только «мелкие»
...
- Crypto заметно выше остальных способов оплаты (7.36% vs 3.33-3.55% у карт / PayPal / UPI)
...
Готовый отчёт: [`powerbi/Enterprise dashbord.pbix`](powerbi/Enterprise%20dashbord.pbix)
